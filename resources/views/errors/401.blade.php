...
<body class="antialiased bg-gray-900 min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        <!-- Key Icon -->
        <div class="mb-8">
            <div class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-yellow-500/10 border-2 border-yellow-500/50">
                <svg class="w-12 h-12 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <!-- Error Message -->
        <h1 class="text-4xl font-bold text-white mb-2">401</h1>
        <h2 class="text-xl font-medium text-gray-300 mb-4">Session Expired</h2>
